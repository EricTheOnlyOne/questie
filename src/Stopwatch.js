...
import { faUndoAlt, faCirclePlay, faCirclePause, faCircleArrowLeft } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className='Activities-list'>
        {activities.map((act, index) => (
          <div key={index} className={`Activity-item ${act.isEditing ? 'editing' : ''}`}>
            ...
            <TabsButton text='Reassign' icon={faCircleArrowLeft} onClick={() => reassignActivity(index)} className='height-fit-content small-font' />
          </div>
        ))}
      </div>
    </div>
